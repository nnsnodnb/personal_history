...
- サーバサイドは `pytest` を使ったテストコードの実装を行い現在600件のテストコードが存在
...
今までいろんなサービスの開発や保守に携わってきて、0→1の開発をやっていて楽しく好きだなって思っているので、可能であればサービス立ち上げなどもしたい。

今までやってきた以上の効率的な自動化、アーキテクチャ設計など。

サービスとしてやらないのであればやらなくてもいいと思っているけど、 iOS アプリの開発をやりながらサーバサイド(可能なら Python)開発を続けていきたい。どちらかという選択肢でも。  
Go とかもやってみたい。
...
- 自分もこうなりたいと思えるような優秀な人がいる
- 常に技術知識の I/O を行っているような人がいる
- できれば非喫煙者しかいない、香水の臭いがきつい人がいない
  - 喘息(予備軍)持ちなので喫煙後30分以内なら臭いがわかって苦しい

### 文化

- スーツは絶対に着たくない
- 平日のカンファレンスへの参加を許可してくれる
  - 平日夜の勉強会等への参加が定時より早い場合も早退扱いとかでなく行っていいとか
- いい意味でオープン
- 強制自費飲み会参加がない (お酒が飲めないから他の人と同料金で割り勘にされるのは嫌だ)
  - 誘われたら特に用事がない場合は喋るの好きなので普通に行きます
- 身体障害に対する偏見がない
  - 病気が重なりすぎてなんとも言えないけど一旦、左目先天性眼球癆と診断はされています
  - 障害者手帳は手続きとかが面倒なのと5か6級しか取れないと思うので持ってても意味がないと言われているので持ってません
- 突然、次の日に髪の毛の色が変わっていても黒に染めてこいとか言われない(さすがに金とか真っ赤とかダメとかは先に言ってくれると助かります)
  - やったことがある色: 金、赤、ピンク、紫、青

### 働き方

- 労働基準法に則った労働ができる(ブラック企業ではない)
- 仕事に必要な環境(PC や周辺機器など)が支給される
  - 〜3社、自費で買った設備を使用してきたため
- 自宅の環境以上とは言わないが作業中にマシンがフリーズして作業できなくなるなどのイライラが発生しない環境が支給される
 - 支給される PC の OS の選択権がある
     - 今まで仕事はずっと macOS なので macOS がいい
 - 参考までに自宅の環境
     - Mac Pro Late 2013
    ...
    - オカムラ Sylphy シリーズ C681XW-FMP1
    - LAN 内でのデバイス間通信ができる
- リモートワークでもできる仕事であればリモートで仕事をしていきたい
- みなし残業がある場合、「これって何？旨味は何？」ということが説明できる。
- 1日仕事して、いい感じに疲れるぐらいで終わることができるぐらいの仕事具合
  - ずっと忙しくてデスマッチ状態ではない
  - 暇な時間ができてしまうことはない
- (出社が必要な場合)仕事中イヤホンやヘッドフォンをつけていてもいい
- フレックスで働きたい
  - どれだけ疲れててすぐに寝られそうなときでも朝まで寝られずにパフォーマンスが発揮できないときがたまにある

### 給料

- 今まで普通にたまに贅沢してあとは普通に暮らしてちょっと貯金ができるぐらいならいいやって思っていたけどやっぱりそうじゃなかった。( ~~どれだけ残業しても残業がでないなど~~ )
- お金に困っていることはないが、貢献度が正当に評価されていてほしい
- 出社義務があるのであれば会社の近くに引っ越したい
  - 電車通勤は時差通勤をするにしろ喘息(予備軍)持ちなので夏場とか香水とかの臭いで倒れかける→なんでただでさえ暑いのにマスクつけろとか言われないといけないのか理解できない
  - 今の家はそろそろ引っ越ししたいと考えてはいる(近隣からの騒音被害)
...
- いきなり無計画エクストリーム(日帰り)旅行
- 映画鑑賞
- マインスイーパー
- 植物や花をメインの写真撮影
  - 1人デートスポット巡りと題して都内を散策します
  - 無計画エクストリーム旅行で
  - 人物を撮るのは主義には合わないのですがたまにカンファレンスカメラマンとして出動します

<img src="https://user-images.githubusercontent.com/9856514/83679650-bbe61500-a61a-11ea-970d-1f5aebfeebae.JPG" alt="紅葉" width="245px"> <img src="https://user-images.githubusercontent.com/9856514/83679784-ed5ee080-a61a-11ea-8faf-8937c5570946.png" alt="ガーデンローズ" width="245px"> <img src="https://user-images.githubusercontent.com/9856514/83681646-a8887900-a61d-11ea-82f4-c862cde1c597.JPG" alt="青の洞窟" width="245px">

## 謝辞

[bannzai/PersonalHistory](https://github.com/bannzai/PersonalHistory) を参考にさせていただきました⭐️⭐️⭐️⭐️⭐️
